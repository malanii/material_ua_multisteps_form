...
export const Address = ({formData, setForm, navigation }) =>{
    ...
    return (
        <Container maxWidth='xs'>
            <h1>Address</h1>
            <TextField label="Address" name = 'address' value={address}  onChange={setForm}
                       margin='normal' variant='outlined' autoComplete='off' fullWidth/>
            <TextField label="city" name = 'city' value={city}  onChange={setForm}
                       margin='normal' variant='outlined' autoComplete='off' fullWidth/>
            <TextField label="zip" name = 'zip' value={zip}  onChange={setForm}
                       margin='normal' variant='outlined' autoComplete='off' fullWidth/>
            <TextField label="country" name = 'country' value={country}  onChange={setForm}
                       margin='normal' variant='outlined' autoComplete='off' fullWidth/>
